...
class AbstractEnrollingBase(object):
    ...
    @WithSharedApplicationMockDS(users=(u'aaa_nextthought_com',),
                                 testapp=True,
    ...
    def test_fetch_administered_courses(self):
        ...
        with mock_dataserver.mock_db_trans(self.ds):
            ...
            IFriendlyNamed(steve).realname = u'Steve Johnson'
            IFriendlyNamed(jason).realname = u'Jason Madden'
        ...
        self.testapp.put_json(last_viewed_href, 1234,
                              extra_environ=instructor_env)
        res = self.testapp.get(activity_link, extra_environ=instructor_env)
    ...
    def _do_enroll(self, postdata):
        ...
        # this will probably get stricter. Raw strings are allowed but not
        # preferred.
    ...
    def test_enroll_unenroll_using_workspace(self):
        ...
        # Because we are an admin, we can also access the global roster that
        # will show us in it
